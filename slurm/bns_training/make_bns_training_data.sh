...
# ============================================================================
# BNS Training Data Generator
# ============================================================================
# This script generates BNS GW events optimized for deep learning training.
...
echo "=============================================="
echo "BNS Training Data Generator"
echo "=============================================="
echo "Run:              $RUNS"
echo "Seed:             $SEED"
...
if [ ! -f "$DIST_FILE" ]; then
  echo "[Step 0/4] Generating training distribution file..."
  uv run python scripts/generate_bns_training_distribution.py \
    -o "$DIST_FILE" \
    -n "$NSAMPLES" \
    --mass-min 1.0 \
    --mass-max 2.05 \
...
for run in $RUNS; do
  ...
  OUTDIR="runs/$run/bns_training_seed${SEED}"
  mkdir -p "$OUTDIR"

  # Step 1: Generate BNS injections with custom distribution
